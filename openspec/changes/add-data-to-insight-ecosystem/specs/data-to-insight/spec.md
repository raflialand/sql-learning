...
- `.opencode/skills/data-to-insight/SKILL.md` — orchestrator skill (to be created)
- `.opencode/agents/sql-builder.md` — SQL-authoring subagent (to be created)
- `.opencode/agents/insight-writer.md` — insight-synthesis subagent (to be created)
- `agent-blueprints/03-data-to-insight.md` — canonical blueprint (to be created)
