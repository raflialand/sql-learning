# sql-analyst-lab Specification

## Purpose
Govern the SQL Analyst Lab learning module: open-ended, framework-driven data-to-insight case studies that reuse the shared sql-skill-push datasets read-only, produce verified expected results, and register a learning-progress track without modifying either dependency's contracts.
