...
Generate realistic business cases with System Analysis Documents (SAD) from user-provided datasets and READMEs.
...
- `.opencode/agents/case-generator.md` — agent definition
- `learning/04-data-to-insight/generated-case/` — output directory for generated cases
