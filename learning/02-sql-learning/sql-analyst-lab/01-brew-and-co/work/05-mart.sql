...
-- Run (single statement, run_query.py-ready):
--   python ../sql-skill-push/_tools/run_query.py ../sql-skill-push/datasets/01-beginner/retail.db work/05-mart.sql
